...
class PatientDetails {
  ...
  Future<bool> setDiagnosticCustomerFromDatabase() async {
    DoctorCustomer dgc = await _apiServices
...
class DoctorAppointments {
  ...
  // ----------------------------------------------------------------
  static DoctorCustomer _selectedDiagnosticCustomer;
  DoctorCustomer getSelectedDiagnosticCustomer() =>
      _selectedDiagnosticCustomer;
  void setSelectedDiagnosticCustomer(DoctorCustomer doc) {
